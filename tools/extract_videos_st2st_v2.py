...
# output
train_img_folder = "{}-new/training_256".format(folder_root)
val_img_folder = "{}-new/validation_256".format(folder_root)
test_img_folder = "{}-new/testing_256".format(folder_root)
train_file_list = "{}-new/training_256.txt".format(folder_root)
val_file_list = "{}-new/validation_256.txt".format(folder_root)
test_file_list = "{}-new/testing_256.txt".format(folder_root)
